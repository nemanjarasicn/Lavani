...
export default class Novi_odmor extends Component {
  constructor(props) {
    ...
    this.idOdmor =
      props.params.route.params.idOdmor != undefined
        ? props.params.route.params.idOdmor
        : '';
    ...
    if (this.idOdmor != '') {
      this.H.callFetch({
        ...
        func: data => {
          ...
          this.props.params.set.sifDeoGodOdmora({
            value: data[2],
            label: data[8],
          });
      ...
      <View style={this.H.ObjAss({}, style.column, style.flex_1)}>
        ...
        <View style={style.flex_1}>
          <ScrollView>
              ...
              <View
                ...
                <RNPickerSelect
                  onValueChange={(value, index) => {
                    params.set.sifDeoGodOdmora({
                      value: value,
                      label: this.sifDeoGodOdmora[index - 1].label,
                    });
                  }}
            ...
            <View style={this.H.ObjAss({}, style.mar_15, style.column)}>
              ...
              <TextInput
                style={this.H.ObjAss({height: 50, borderWidth: 1}, style.txt_c)}
                placeholder={txt.trajanje}
                onChangeText={value => {
                  params.set.trajanje(value);
                }}
            ...
            <View style={this.H.ObjAss({}, style.mar_15, style.column)}>
              ...
              <TextInput
                style={this.H.ObjAss({height: 50, borderWidth: 1}, style.txt_c)}
                placeholder={txt.preostalo_dana}
                onChangeText={value => {
                  params.set.preostaliDani(value);
                }}
            ...
            <View style={this.H.ObjAss({}, style.mar_15, style.column)}>
              ...
              <TextInput
                style={this.H.ObjAss({height: 50, borderWidth: 1}, style.txt_c)}
                placeholder={txt.ukupno_dana}
                onChangeText={value => {
                  params.set.ukupnoDana(value);
                }}
        ...
        <TouchableOpacity
          onPress={() => {
            ...
            else if (Number(params.get.preostaliDani) < 0)
              Alert.alert(this.txt.upozorenje, this.txt.trajanje_vece);
            else if (params.get.ukupnoDana == 0)
              Alert.alert(this.txt.upozorenje, this.txt.odmor_jednak_nuli);
            else {
              let dan1, mesec1, dan2, mesec2;
              dan1 =
                String(this.props.params.get.dod_d).length < 2
                  ...
                  if (res) {
                    this.H.callFetch({
                      ...
                      func: res => {
                        ...
                        params.navigation.navigate('Odmor_unos_edit', {
                          entitet: this.entitet,
                        });
                      },
                    });
