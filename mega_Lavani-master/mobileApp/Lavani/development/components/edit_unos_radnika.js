...
export default  class Edit_unos_radnika extends Component{
	constructor(props){
	    ...
	    this.state 		= {}
	    this.idRadnik   = (props.params.route.params.idRadnik != undefined)? props.params.route.params.idRadnik : '' ;
		...
		if(this.idRadnik != ''){
			this.H.callFetch({
				...
				func: (res)=>{
					...
					//this.props.params.set.radnoMesto({value:data[9], label: ''})
	...
	izracunajStaz = (d = 0, m = 0, y = 0) => {
		const kraj = (this.props.params.get.dpr_d != '' && this.props.params.get.dpr_m != '' && this.props.params.get.dpr_y != '' )?
			`${this.props.params.get.dpr_d}-${this.props.params.get.dpr_m}-${this.props.params.get.dpr_y}`
			:
			'';
		//tekuci
		this.H.callFetch({
			...
			data:{
				pocetak: `${this.props.params.get.dp_d}-${this.props.params.get.dp_m}-${this.props.params.get.dp_y}`,
				kraj: kraj
			},
			func: (res)=>{
				...
				//ukupno
				this.izracunajUkupniStaz(parseInt(d) + parseInt(res[0]), parseInt(m) + parseInt(res[1]), parseInt(y) + parseInt(res[2]))
			}
		})
	}
	...
	componentDidMount(){
		...
		//this.getSif('radnoMesto', 'EZ_SIF_RADNA_MESTA')
		...
		return (
	  		<View style={this.H.ObjAss({}, style.column, style.flex_1)}>
	  			<View style={this.H.ObjAss({height:50}, style.center, style.flex_0)}>
	  				<Text style={this.H.ObjAss({fontSize:16}, style.txt_c)}>{txt.radnik}: {params.get.ime} {params.get.prezime}</Text>
	  			</View>
	  			<View  style={style.flex_1}>
		  			<ScrollView >
		  				<View style={this.H.ObjAss({}, style.mar_15, style.column)}>
		  					<Text>{txt.ime}:</Text>
			  				<TextInput style={this.H.ObjAss({height:50, borderWidth:1}, style.txt_c)} placeholder={txt.ime}
			  					onChangeText={(value)=>{params.set.ime(value)}}
			  					value={params.get.ime}
			  				/>
		  				</View>
		  				<View style={this.H.ObjAss({}, style.mar_15, style.column)}>
		  					<Text>{txt.prezime}:</Text>
			  				<TextInput style={this.H.ObjAss({height:50, borderWidth:1}, style.txt_c)} placeholder={txt.prezime}
			  					onChangeText={(value)=>{params.set.prezime(value)}}
			  				...
			  				<View style={this.H.ObjAss({}, style.row, style.center)}>
			  					<View>
				  					...
				  					<TextInput style={this.H.ObjAss({height:50, width:50, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_dan}
				  						onChangeText={(value)=>{params.set.dr_d(value)}}
				  				...
				  				<View>
				  					...
				  					<TextInput style={this.H.ObjAss({height:50, width:50, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_mesec}
				  						onChangeText={(value)=>{params.set.dr_m(value)}}
			  					...
			  					<View>
				  					...
				  					<TextInput style={this.H.ObjAss({height:50, width:100, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_godina}
				  						onChangeText={(value)=>{params.set.dr_y(value)}}
			  			...
			  			<View style={this.H.ObjAss({}, style.mar_15, style.column)}>
		  					<Text>{txt.jmbg}:</Text>
			  				<TextInput style={this.H.ObjAss({height:50, borderWidth:1}, style.txt_c)} placeholder={txt.jmbg}
			  					onChangeText={(value)=>{params.set.jmbg(value)}}
			  					value={params.get.jmbg}
			  				/>
		  				</View>
		  				<View style={this.H.ObjAss({}, style.mar_15, style.column)}>
		  					<Text>{txt.lk}:</Text>
			  				<TextInput style={this.H.ObjAss({height:50, borderWidth:1}, style.txt_c)} placeholder={txt.lk}
			  					onChangeText={(value)=>{params.set.lk(value)}}
			  					value={params.get.lk}
			  				/>
		  				</View>
		  				<View style={this.H.ObjAss({}, style.mar_15, style.column)}>
			  				...
			  				<View style={this.H.ObjAss({height:50, borderWidth:1}, style.txt_c)}>
				  				<RNPickerSelect
						            onValueChange={(value, index) => {params.set.strucnaSprema({value: value, label: this.strucnaSprema[index-1].label})}}
						...
						<View style={this.H.ObjAss({}, style.mar_15, style.column)}>
							<Text>{txt.radno_mesto}:</Text>
			  				<View style={this.H.ObjAss({height:50, borderWidth:1}, style.txt_c)}>
				  				<RNPickerSelect
						            onValueChange={(value, index) => {params.set.radnoMesto({value: value, label: this.radnoMesto[index].label})}}
						            items={this.radnoMesto}
						            value={params.get.radnoMesto.value}
						            useNativeAndroidPickerStyle={false}	
						            placeholder={{label:txt.radno_mesto}}
						        />
						    </View>
						</View>
						*/}
						<View style={this.H.ObjAss({}, style.mar_15, style.column)}>
						    ...
						    <View style={this.H.ObjAss({height:50, borderWidth:1}, style.txt_c)}>
				  				<RNPickerSelect
						            onValueChange={(value, index) => {params.set.vrstaZaposlenja({value: value, label: this.vrstaZaposlenja[index-1].label})}}
		  				...
		  				<View style={this.H.ObjAss({}, style.column)}>
			  				...
			  				<View style={this.H.ObjAss({}, style.row, style.center)}>
			  					<View>
				  					<Text style={style.txt_c}>{txt.dan}</Text>
				  					<TextInput style={this.H.ObjAss({height:50, width:50, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_dan}
				  						onChangeText={(value)=>{params.set.dp_d(value)}}
				  				...
				  				<View>
				  					<Text style={style.txt_c}>{txt.mesec}</Text>
				  					<TextInput style={this.H.ObjAss({height:50, width:50, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_mesec}
				  						onChangeText={(value)=>{params.set.dp_m(value)}}
			  					...
			  					<View>
				  					<Text style={style.txt_c}>{txt.godina}</Text>
				  					<TextInput style={this.H.ObjAss({height:50, width:100, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_godina}
				  						onChangeText={(value)=>{params.set.dp_y(value)}}
		  				...
		  				<View style={this.H.ObjAss({}, style.column)}>
			  				...
			  				<View style={this.H.ObjAss({}, style.row, style.center)}>
			  					<View>
				  					<Text style={style.txt_c}>{txt.dan}</Text>
				  					<TextInput style={this.H.ObjAss({height:50, width:50, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_dan}
				  						onChangeText={(value)=>{params.set.dpr_d(value)}}
				  				...
				  				<View>
				  					<Text style={style.txt_c}>{txt.mesec}</Text>
				  					<TextInput style={this.H.ObjAss({height:50, width:50, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_mesec}
				  						onChangeText={(value)=>{params.set.dpr_m(value)}}
			  					...
			  					<View>
				  					<Text style={style.txt_c}>{txt.godina}</Text>
				  					<TextInput style={this.H.ObjAss({height:50, width:100, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_godina}
				  						onChangeText={(value)=>{params.set.dpr_y(value)}}
		  				...
		  				<View style={this.H.ObjAss({}, style.column)}>
			  				...
			  				<View style={this.H.ObjAss({}, style.row, style.center)}>
			  					<View>
				  					...
				  					<TextInput style={this.H.ObjAss({height:50, width:50, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_dan}
				  						onChangeText={(value)=>{params.set.stazDan(value)}}
				  				...
				  				<View>
				  					...
				  					<TextInput style={this.H.ObjAss({height:50, width:50, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_mesec}
				  						onChangeText={(value)=>{params.set.stazMesec(value)}}
			  					...
			  					<View>
				  					...
				  					<TextInput style={this.H.ObjAss({height:50, width:100, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_godina}
				  						onChangeText={(value)=>{params.set.stazGodina(value)}}
			  				...
			  				<TouchableOpacity onPress={()=>{this.izracunajStaz(params.get.stazDan, params.get.stazMesec, params.get.stazGodina)}}>
		  				...
		  				<View style={this.H.ObjAss({}, style.column)}>
			  				...
			  				<View style={this.H.ObjAss({}, style.row, style.center)}>
			  					<View>
				  					<Text style={style.txt_c}>{txt.staz_dan}</Text>
				  					<TextInput style={this.H.ObjAss({height:50, width:50, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_dan}
				  						onChangeText={(value)=>{params.set.stazDan_t(value)}}
				  				...
				  				<View>
				  					<Text style={style.txt_c}>{txt.staz_mesec}</Text>
				  					<TextInput style={this.H.ObjAss({height:50, width:50, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_mesec}
				  						onChangeText={(value)=>{params.set.stazMesec_t(value)}}
			  					...
			  					<View>
				  					<Text style={style.txt_c}>{txt.staz_godina}</Text>
				  					<TextInput style={this.H.ObjAss({height:50, width:100, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_godina}
				  						onChangeText={(value)=>{params.set.stazGodina_t(value)}}
		  				...
		  				<View style={this.H.ObjAss({}, style.column)}>
			  				...
			  				<View style={this.H.ObjAss({}, style.row, style.center)}>
			  					<View>
				  					<Text style={style.txt_c}>{txt.staz_dan}</Text>
				  					<TextInput style={this.H.ObjAss({height:50, width:50, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_dan}
				  						onChangeText={(value)=>{params.set.stazDan_u(value)}}
				  				...
				  				<View>
				  					<Text style={style.txt_c}>{txt.staz_mesec}</Text>
				  					<TextInput style={this.H.ObjAss({height:50, width:50, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_mesec}
				  						onChangeText={(value)=>{params.set.stazMesec_u(value)}}
			  					...
			  					<View>
				  					<Text style={style.txt_c}>{txt.staz_godina}</Text>
				  					<TextInput style={this.H.ObjAss({height:50, width:100, borderWidth:1}, style.mar_15, style.txt_c)} placeholder={txt.staz_godina}
				  						onChangeText={(value)=>{params.set.stazGodina_u(value)}}
		  					...
		  					<View style={this.H.ObjAss({}, style.mar_30, style.column)}>
		  						...
		  						<TouchableOpacity onPress={async ()=>{
									...
									try {
									  ...
									  params.set.dokumentList(params.get.dokumentList + tmpList)
									} catch (err) {
	  			...
	  			<TouchableOpacity onPress={()=>{
					...
					else if(params.get.jmbg.length != 13) Alert.alert(txt.upozorenje, txt.jmbg_mora_13)
					else{
						this.izracunajStaz(params.get.stazDan, params.get.stazMesec, params.get.stazGodina)
						const kraj = (params.get.dpr_d != '' && params.get.dpr_m != '' && params.get.dpr_y != '' )?
							`${params.get.dpr_d}-${params.get.dpr_m}-${params.get.dpr_y}`
							:
							'';
						this.H.callFetch({
							...
							data: {
								...
								datum_rodjenja: `${params.get.dr_d}-${params.get.dr_m}-${params.get.dr_y}`,
								pocetak: `${params.get.dp_d}-${params.get.dp_m}-${params.get.dp_y}`,
								kraj: kraj
							},
							func: (res)=>{
								if(params.get.dokument.length > 0){
									...
									params.get.dokument.forEach((el)=>{
										this.H.callFetch({
											url: this.Con.endpoint + 'radnik.cfc?method=ins_upd_dok&entitet='+this.entitet+'&id='+res,
											data: el,
											func:(res)=>{
												console.log(res)
								...
								this.H.callFetch({
									...
									func:(res)=>{
										...
										params.navigation.navigate('Unos_radnika_home', {entitet: this.entitet})
									}
								})
							}
						})
