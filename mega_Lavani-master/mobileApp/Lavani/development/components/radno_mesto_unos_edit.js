...
export default class Radno_mesto_unos_edit extends Component {
  constructor(props) {
    ...
    this.state = {};
    this.idRM =
      props.params.route.params.idRM != undefined
        ? props.params.route.params.idRM
        : '';
    this.idORM =
      props.params.route.params.idORM != undefined
        ? props.params.route.params.idORM
        : '';
          ...
          <ScrollView>
            ...
            <View style={this.H.ObjAss({}, style.mar_15, style.column)}>
              ...
              <TextInput
                ...
                placeholder={txt.raspoloziv_neto}
                onChangeText={value => {
                  params.set.neto(value);
                }}
            ...
            <View style={this.H.ObjAss({}, style.mar_15, style.column)}>
              ...
              <TextInput
                style={this.H.ObjAss({height: 50, borderWidth: 1}, style.txt_c)}
                placeholder={txt.raspoloziv_doprinos}
                onChangeText={value => {
                  params.set.doprinosi(value);
                }}
            ...
            <View style={this.H.ObjAss({}, style.mar_15, style.column)}>
              ...
              <TextInput
                style={this.H.ObjAss({height: 50, borderWidth: 1}, style.txt_c)}
                placeholder={txt.raspoloziv_za_porez}
                onChangeText={value => {
                  params.set.prevoz(value);
                }}
            ...
            <View style={this.H.ObjAss({}, style.mar_15, style.column)}>
              ...
              <TextInput
                style={this.H.ObjAss({height: 50, borderWidth: 1}, style.txt_c)}
                placeholder={txt.raspoloziv_za_topli}
                onChangeText={value => {
                  params.set.topliObrok(value);
                }}
            ...
            <View style={this.H.ObjAss({}, style.mar_15, style.column)}>
              ...
              <TextInput
                style={this.H.ObjAss({height: 50, borderWidth: 1}, style.txt_c)}
                placeholder={txt.raspoloziv_za_regres}
                onChangeText={value => {
                  params.set.regres(value);
                }}
            ...
            <View style={this.H.ObjAss({}, style.mar_15, style.column)}>
              ...
              <TextInput
                style={this.H.ObjAss({height: 50, borderWidth: 1}, style.txt_c)}
                placeholder={txt.predvidjeni_sati}
                onChangeText={value => {
                  params.set.predvidjeniSati(value);
                }}
            ...
            <View style={this.H.ObjAss({}, style.mar_15, style.column)}>
              ...
              <TextInput
                style={this.H.ObjAss({height: 50, borderWidth: 1}, style.txt_c)}
                placeholder={txt.broj_zaposlenih}
                onChangeText={value => {
                  params.set.brojZaposlenih(value);
                }}
